...
func GetListGroups(user app_user.User) ([]line_model.LineGroup, error) {
...
func GetGroup(user app_user.User, group_id string) (line_model.LineGroup, error) {
...
func JoinGroup(group line_model.LineGroup, user app_user.User) {
